# Generic LLM Instructions — Fileslicer

- **Project:** Fileslicer
- **Target:** generic
- **Mode:** lean
- **Documents:** 7
- **Estimated total tokens:** 2,149
- **Per-bundle token budget:** 40,000
...
```text
You are working with curated source material for: Fileslicer.
